...
const sections = [
  ...
  },
  {
    ...
    body: "Διαχειριστής: Χρήστος Τσούνης\nΗ JNBC Μονοπρόσωπη Ι.Κ.Ε. κατέχει ποσοστό 95% στην εταιρεία. Τελικός πραγματικός δικαιούχος είναι ο Χρήστος Τσούνης του Χριστοφόρου.\nΗ WECOM Μονοπρόσωπη Ι.Κ.Ε. κατέχει ποσοστό 5% στην εταιρεία. Πραγματικός δικαιούχος πίσω από τη WECOM Μονοπρόσωπη Ι.Κ.Ε. είναι ο Γεώργιος Τσούνης του Χριστοφόρου.",
  },
  {
